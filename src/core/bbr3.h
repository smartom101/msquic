...
typedef struct BBR3_BANDWIDTH_FILTER {
    ...
    QUIC_SLIDING_WINDOW_EXTREMUM_ENTRY WindowedMaxFilterEntries[kBbr3DefaultFilterCapacity];

} BBR3_BANDWIDTH_FILTER;
...
typedef struct QUIC_CONGESTION_CONTROL_BBR3 {
    ...
    //
    BBR3_BANDWIDTH_FILTER BandwidthFilter;
